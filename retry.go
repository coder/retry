...
// If you want an error to stop the retry but not be logged, use Log() after Condition.
// If you want an error to stop the retry but be logged, use Log() before Condition.
